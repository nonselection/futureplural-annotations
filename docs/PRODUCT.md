...
3. **Slice 2A — B0 foundation:** in progress. Backend-independent models/codecs/reconciliation and read-only desktop preparation are complete; persistence, platform/device evidence, and the human storage checkpoint remain. Stop at explicit B0 with the full evidence set.
